...
func Account() {
	...
	fmt.Println("----------------------")
	fmt.Println(reflect.TypeOf(autoGeneratedpos.Positions[positionBTCindex].PositionAmt))

	// positionSize := autoGeneratedpos.Positions[positionBTCindex].PositionAmt
	// positionSizeChan <- positionSize
}
