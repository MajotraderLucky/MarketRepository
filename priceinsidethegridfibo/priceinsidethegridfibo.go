...
func Priceingrid(ch chan bool) {
	...
	fmt.Println("long Fibo 236 =", longFib236, reflect.TypeOf(longFib236))
	...
	priceBetween236and786 := askPriceFloat < longFib236 && askPriceFloat > longFib786

	ch <- priceBetween236and786
}
