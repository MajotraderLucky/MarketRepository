...
func ConvertMaxMinToString(max int, min int) (string, string, error) {
	...
	return maxString, minString, nil
}
...
func ConvertFibonacciLevelsToInts(floLevels []float64) ([]int64, error) {
	...
	// Конвертация каждого уровня в int64 и его сохранение в новый слайс
	for i, floLevel := range floLevels {
		intLevels[i] = int64(math.Round(floLevel))
	}
