...
func FindOrderLevel() {
	...
	// fmt.Println("Ask price float =", askPriceFloat, reflect.TypeOf(askPriceFloat))

	priceAbove236 := askPriceFloat > longFib236
	...
	priceBelow786 := askPriceFloat < longFib786
	fmt.Println("Price below the level 786 -", priceBelow786)
	fmt.Println("----------------------")
}
